...
import { Sparkline } from "@/pages/VisaoGeral/components/Sparkline";
import { type EtlData } from "@/lib/utils";
import { ReactNode } from "react";
import { formatNumber } from "@/lib/utils";
import { Skeleton } from "@/components/ui/skeleton";

interface VolumetriaKpiDiarioCardProps {
  title: string;
  value: number | string;
  sparkData: EtlData[];
  description?: string;
...
export function VolumetriaKpiDiarioCard({
  title,
  value,
  sparkData,
  description,
  icon,
}: VolumetriaKpiDiarioCardProps) {
  return (
...
export function VolumetriaKpiDiarioCardSkeleton() {
  return (
    <Card className="flex flex-col items-start p-4 gap-2 min-w-[180px]">
